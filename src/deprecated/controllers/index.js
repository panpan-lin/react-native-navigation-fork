...
var RCCEventEmitter = new OriginalReactNative.NativeEventEmitter(OriginalReactNative.NativeModules.RCCEventEmitter); /*SAPPHIRE CUSTOM*/
  ...
  hijackReact: function () {
    return {
      ...
      TabBarControllerIOS: {
        ...
        MiddleButton: {name: 'TabBarControllerIOS.MiddleButton'}/*SAPPHIRE CUSTOM*/
      },
